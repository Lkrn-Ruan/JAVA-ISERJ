...
public class EstudoCaso extends JFrame {
    ...
    public EstudoCaso(){
        ...
        bordaPainelTop = BorderFactory.createTitledBorder( "Informacoes Pessoais");
       painelTop.setBorder(bordaPainelTop);
        ...
        bordaPainelMid = BorderFactory.createTitledBorder( "Descncao Pessoal e Expenencia Professional");
        ...
        bordaPainelDown = BorderFactory.createTitledBorder( "Objetivo Professional"); 
